...
def menu():
    print("Welcome to Breakthrough: AI-Powered Brick Buster")
...
def trained_model():
    ...
    learner2.exploitation_ratio = 1.0  
...
def play(rounds=1000, discount_factor=0.1, learning_rate=0.1,
    ...
    for played_games in range(0, rounds):
        ...
        itera = 0
        while (done != True) and (itera < 300000 and game.get_total_reward() <= 10000000):
